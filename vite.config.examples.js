  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "custom-mipmaps": resolve(__dirname, "examples/custom-mipmaps.html"),
        "custom-mipmaps-gl": resolve(__dirname, "examples/custom-mipmaps-gl.html"),
        ...
        "realtime-gl": resolve(__dirname, "examples/realtime-gl.html"),
